...
class ScoreBoard extends React.Component {
    ...
    _renderItem = ({item, index}) => (
        <View style={{ flexDirection: 'row',  paddingBottom: 5, borderTopWidth: 1, borderTopColor: '#fff'}}>
            <Text style={{textAlign: 'center', fontWeight: 'bold', width: 15, fontSize: 18, color: 'white', backgroundColor: 'rgba(0, 0, 0, 0.5)', borderBottomLeftRadius: 4, borderBottomRightRadius: 4}}>{index+1}</Text>
    ...
    render() {
      return (
        <View style={{ padding: 10, marginTop: 20, borderRadius: 4, borderWidth: 2, borderColor: '#fff', backgroundColor: 'rgba(255, 255, 255, 0.8)', width: 250 }}>
